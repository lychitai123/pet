...
const routes = [
    { path: 'home', loadChildren: () => __webpack_require__.e(/*! import() | layouts-layout-module */ "layouts-layout-module").then(__webpack_require__.bind(null, /*! ./layouts/layout.module */ "./src/app/layouts/layout.module.ts")).then(m => m.LayoutModule) },
