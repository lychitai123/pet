...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["layouts-layout-module"], {
  ...
  function srcAppLayoutsLayoutRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var routes = [{
      ...
      loadChildren: function loadChildren() {
        ...
        /*! ./about/about.module */
        "./src/app/layouts/about/about.module.ts")).then(function (m) {
      ...
      loadChildren: function loadChildren() {
        return __webpack_require__.e(
        /*! import() | education-education-module */
        "education-education-module").then(__webpack_require__.bind(null,
        /*! ./education/education.module */
        "./src/app/layouts/education/education.module.ts")).then(function (m) {
      ...
      loadChildren: function loadChildren() {
        ...
        "award-award-module").then(__webpack_require__.bind(null,
        /*! ./award/award.module */
        "./src/app/layouts/award/award.module.ts")).then(function (m) {
          return m.AwardModule;
        });
      }
    }, {
      path: 'experience',
      loadChildren: function loadChildren() {
        ...
        "experience-experience-module").then(__webpack_require__.bind(null,
        /*! ./experience/experience.module */
        "./src/app/layouts/experience/experience.module.ts")).then(function (m) {
      ...
      loadChildren: function loadChildren() {
        return __webpack_require__.e(
        /*! import() | interest-interest-module */
        "interest-interest-module").then(__webpack_require__.bind(null,
        /*! ./interest/interest.module */
        "./src/app/layouts/interest/interest.module.ts")).then(function (m) {
          return m.InterestModule;
        });
      }
    }, {
      path: 'skill',
      loadChildren: function loadChildren() {
        ...
        "skill-skill-module").then(__webpack_require__.bind(null,
        /*! ./skill/skill.module */
        "./src/app/layouts/skill/skill.module.ts")).then(function (m) {
  ...
  function srcAppLayoutsLayoutModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _layout_routing_module__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    ...
    LayoutModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      providers: [],
      imports: [[_layout_routing_module__WEBPACK_IMPORTED_MODULE_1__["LayoutRoutingModule"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"]]]
    });
...
//# sourceMappingURL=layouts-layout-module-es5.js.map